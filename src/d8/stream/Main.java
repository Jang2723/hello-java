...
public class Main {
    public static void main(String[] args) {
        ...
        final int a = 10;
        int b =20;
        // 함수가 실행될 때 해당 변수에 접근할 수 있다는 걸
        // 보장할 수 없다.
        // 함수의 기능이 예측이 불가해지기 때문에 변겨 가능한 변수를 허용하지 않는다.
        NoArgRetFunction multilineLambda = () -> {
            System.out.println(a); // final이 부은 애들만 할당 가능
            // b = 30; // error 만들어진 시점과 사용하는 시점이 달라 변하지 않는 변수만 사용가능
